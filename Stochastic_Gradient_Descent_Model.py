...
# Mean Absolute Error
MAE = mean_absolute_error(DP.Y_Train, SGD.Y_Prediction)
...
MAPE = mean_absolute_percentage_error(DP.Y_Train, SGD.Y_Prediction)
print(f'Mean Absolute Percentage Error: {MAPE}%')

# Mean Squared Error
MSE = mean_squared_error(DP.Y_Train, SGD.Y_Prediction)
print(f'Mean Squared Error: {MSE}')

# Root Mean Squared Error
RMSE = mean_squared_error(DP.Y_Train, SGD.Y_Prediction, squared=False)
print(f'Root Mean Squared Error: {RMSE}')

# Mean Squared Log Error
MLSE = mean_squared_log_error(DP.Y_Train, SGD.Y_Prediction)
print(f'Mean Squared Logarithmic Error: {MLSE}')

# R-squared Error
r2 = r2_score(DP.Y_Train, SGD.Y_Prediction)
print(f'R-squared: {r2}')

# Explained Variance Score
EVS = explained_variance_score(DP.Y_Train, SGD.Y_Prediction)
...
# Get model name
model_name = 'Stochastic_Gradient_Descent_Model_Results'
